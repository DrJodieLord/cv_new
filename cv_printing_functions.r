...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$keyskills    <- readr::read_csv(paste0(data_location, "key_skills.csv"), skip = 1)
...
#' @description Construct a bar chart of key skills
#' @param out_of The relative maximum for skills. Used to set what a fully filled in skill bar is.
print_key_bars <- function(cv, out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
...
#' @description Construct a bar chart of programming skills
#' @param out_of The relative maximum for skills. Used to set what a fully filled in skill bar is.
